...
void Initial_Constant_BC::calculate(ms::math::Vector_Wrapper boundary_flux_vec, const ms::math::Vector_Const_Wrapper oc_solution_vec, const ms::math::Vector_Const_Wrapper normal_vec) const
{
...
void Initial_Constant_BC::calculate_neighbor_solution(const ms::math::Vector_Const_Wrapper& oc_solution_vec) const
{
